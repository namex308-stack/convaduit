    ...
    <PageShell>
      ...
      <PageContent className="max-w-3xl space-y-4">
        {[
          ...
          {
            t: "آلية المعالجة",
            b: "بعد استلام الطلب عبر القناة الرسمية، يراجع فريق الدعم أهلية الطلب ضمن نافذة الـ 14 يوماً ويؤكد بيانات الدفع. عند الموافقة، يُنفَّذ الاسترداد يدوياً عبر مزود الدفع المعتمد في المنصة (مثل Kashier عند استخدامه) — ولا يوجد مسار استرداد تلقائي داخل التطبيق.",
          },
          {
            t: "مدة وصول المبلغ",
