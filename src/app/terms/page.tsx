    ...
    <PageShell>
      ...
      <PageContent className="max-w-3xl space-y-4">
        {[
          ...
          {
            t: "الاشتراكات والدفع",
            b: "تُعرض الأسعار والباقات في صفحة التسعير. تتم المدفوعات عبر مزود الدفع المعتمد في المنصة (مثل Kashier عند تفعيله). إلغاء الاشتراك لا يعني تلقائياً استرداد المبالغ المدفوعة — راجع سياسة الاسترداد.",
          },
          {
            t: "الاستخدام المقبول",
